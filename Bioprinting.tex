...
The field of three dimensional bioprinting is on the rise. Already great strides have been made toward making printing human tissue and eventually organs a reality. 
But as any great innovation, said to revolutionize our way of living, goes - this one too is not without its fair share of controversy.  
This paper will first tackle some of the ethical dilemmas we as a humanity are facing today regarding bioprinting's current state of the art. More specifically, the dilemmas surrounding the use of embryonic stem cells and the inevitable commencement of human clinical trials. The discourse will then move focus to future considerations of the technology's implications related to regulatory issues as well as the ramifications of having the power to design and print better organs than nature intended.  
The discussion is aimed to examine these ethical and moral debates while always keeping in mind and arguing for the position that the benefits of bioprinting organs outweigh the costs; and that bioprinting is set to change our lives for the better by improving the effectiveness and safety of drug trials, personalizing medical treatment, saving lives by bioprinting organs and even by eradicating diseases.
