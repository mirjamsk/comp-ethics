...
Another miracle story is that of a three year old girl born with hydrocephalus\footnotemark{} who was admitted to the hospital after her brain suffered serious infections and a high probability of rupture due to her swollen skull. She underwent an unheard of life saving surgery consisting of constructing and inserting a new 3D printed skull \cite{3dprint.com:2015}. 
...
This raises questions about the ethicalness of offering treatment to desperate patients not fully understanding the consequences and without knowing the outcome.While this can be morally justified by offering the procedure only to people in dire need and through the process of informed consent, there is a greater danger looming behind closed doors. 

According \cite{Army Technology(2014)} The US Army is heavily investing and is hoping to soon begin clinical trials with 3D printed skin. 
...
There is some
 Is it ethical to offer this treatment to patients without knowing the full range of outcomes? This hindrance to testing and safety may require strict regulation of the types and methods of transplants that can be done.

army trials, and the bone company trials we don't even now about. army has done that always (Not to say challenging the status quo shouln't be done, and a lot can be said about how informed is informed consent, but it is to say that this is an all prevasive problem, not strictly tied to bioprinting. But there may be light at the end of the tunnel !!on the bright side, ali to ce se sve prominit kad budemo mogli prvo ispitat na svom vlastitiom sustavu
on the other hand in vivo (animal) clinical trials have faild us time and time again )


Organovo has taken great stridesin the field of bioprinting-mini livers. the only quesiton is when are human trials going to begin 

 have been 
ReDura 10000
Thyroid gland mouse

Let me start by listing a few stories where 3D aided surgical interventions yielded success.


 US Army to use the technology to treat wounded soldiers.
...
\newblock Mitigation of tracheobronchomalacia with 3D-printed personalized medical devices in pediatric patients
...
\newblock Medical Applications for 3-D. Army invests in 3-D bioprinting to treat injured Soldiers
